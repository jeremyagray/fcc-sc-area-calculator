...
class UnitTests(unittest.TestCase):
    ...
    def test_square_is_square_and_rectangle(self):
        ...
        self.assertEqual(
            actual,
            expected,
            "Expected square object to be an instance of the Square class"
    ...
    def test_rectangle_string(self):
        ...
        self.assertEqual(
            actual,
            expected,
            "Expected string representation of rectangle to be"
    ...
    def test_set_atributes(self):
        ...
        self.assertEqual(
            actual,
            expected,
            "Expected string representation of square after setting"
            " new values to be 'Square(side=2)'",
        )
        self.sq.set_width(4)
        actual = str(self.sq)
